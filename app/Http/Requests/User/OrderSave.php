...
class OrderSave extends FormRequest
{
    ...
    public function rules()
    {
        return [
            'plan_id' => 'required',
            'period' => 'required|in:hour_price,day_price,month_price,quarter_price,half_year_price,year_price,two_year_price,three_year_price,onetime_price,reset_price'
        ];
    }
