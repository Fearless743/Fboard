...
class ClashMeta extends AbstractProtocol
{
    ...
    public function handle()
    {
        ...
        $yaml = str_replace('$app_name', admin_setting('app_name', 'Fboard'), $yaml);
